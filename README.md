...
Submit request (usually approved instantly for hackathon)
3. Deploy Backend
...
Create a project → Get Bearer Token
Enter it in the app's Distribution step (never stored server-side)
